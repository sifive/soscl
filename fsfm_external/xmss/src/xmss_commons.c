 ...
 */
static void l_tree(const xmss_params *params, unsigned char *leaf, unsigned char *wots_pk, const unsigned char *pub_seed, uint32_t addr[8])
{
 ...
 */
static void compute_root(const xmss_params *params, unsigned char *root, const unsigned char *leaf, unsigned long leafidx, const unsigned char *auth_path, const unsigned char *pub_seed, uint32_t addr[8])
{
    uint32_t i;
                          ...
                          const unsigned char *pk)
{
    ...
    *mlen = smlen - params->sig_bytes;
    ...
    hash_message(params, mhash, sm + params->index_bytes, pk, idx, m + params->sig_bytes - params->padding_len - 3*params->n, *mlen);
